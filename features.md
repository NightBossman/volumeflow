...
*   **Persistent Audio Bridge (Pro):** Natywny mostek w C# (COM) eliminujący miganie kursora i zaśmiecanie Menedżera Zadań.
...
*   **Globalne Hotkeye + OSD:** Sterowanie scenami skrótami klawiszowymi z eleganckim powiadomieniem na ekranie (On-Screen Display).
*   **Focus Mode:** Automatyczne priorytetyzowanie głośności aktywnego okna (ściszanie tła).
