...
### 🔴 Funkcje "Ambitne" (Future / Experimental)
*   **AI Volume Normalization:** Automatyczne wyrównywanie głośności różnych źródeł w czasie rzeczywistym.
*   **Remote Control:** Aplikacja mobilna/webowa do sterowania głośnością PC z telefonu (przez lokalną sieć).
*   **Per-Device Routing:** Możliwość szybkiego przełączania wyjścia audio dla każdej aplikacji z osobna (np. Muzyka na głośniki, Gra na słuchawki).
